...
import { clientsItem, clientsPotencialItem } from "../../mocks/clientItems";

export const ListClientsPotenciales = (props) => {
  ...
  const renderEventItem = ({ item }) => (
    ...
    >
      ...
      <View style={styles.eventItem}>
        <Text style={styles.eventTitle}>{item.nameLocal}</Text>
